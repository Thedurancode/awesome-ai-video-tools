...
| 9 | **[Magic Hour](https://docs.magichour.ai/api-reference/video-projects/text-to-video)** | `api.magichour.ai/v1/text-to-video` | Bearer token | Credit-based | Multi-tool AI media workflows |
