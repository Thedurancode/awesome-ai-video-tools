...
<p align="center">
  <b>61 open-source repos + 28 production APIs</b><br>
...
The result: **61 hand-picked open-source repos + 28 production APIs**, organized by what they actually do, with real endpoints, real pricing, and real code patterns an agent can copy-paste.
...
| 8 | [Jellypod-Inc/podframes](https://github.com/Jellypod-Inc/podframes) | ⭐7 | TypeScript | Topic-to-podcast video pipeline with mixed TTS, lip-synced avatars, captions, and b-roll |
